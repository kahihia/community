# -*- coding: utf-8 -*-
"""
Django settings for telegramtoken project.
...
INSTALLED_APPS = [
    ...
    'telegramtoken.apps.TelegramTokenConfig',
    'organizations',
]
...
ROOT_URLCONF = 'telegramtoken.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [join(BASE_DIR, 'telegramtoken', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'telegramtoken.wsgi.application'
...
STREAM_TELEGRAM_TOKEN = 'telegram_token'
STREAM_ISCC = 'iscc'

AUTH_USER_MODEL = 'telegramtoken.User'
SUIT_CONFIG = {
    ...
    'MENU': (
      ...
      {'label': 'Organization', 'models': (
          ...
          {'label': 'Organization User', 'models': (
            {'model': 'organizations.organizationuser'},
        )},
          {'label': 'Organization Owner', 'models': (
...
try:
    from telegramtoken.settings.config import *
except Exception:
    print(
        'No custom configuration found. Create a telegramtoken/settings/config.py')
    import sys
